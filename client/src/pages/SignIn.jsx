...
export default function SignIn() {
  ...
  async function handleSubmit(e) {
    ...
    setBusy(true)
    try {
      if (!supabase || !auth?.signIn) throw new Error('Auth is not configured')
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-xl items-center px-6 py-10">
      <div className="w-full rounded-xl border border-border bg-surface p-6">
        ...
        <div className="mb-3 text-lg font-semibold text-text-primary">Sign in</div>
        <div className="mb-5 text-xs text-text-secondary">
          Real-time interviews with an AI interviewer and shared Monaco editor.
        </div>
